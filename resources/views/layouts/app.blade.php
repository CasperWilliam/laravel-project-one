...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center border-bottom shadow-sm p-3 px-md-4 bg-white mb-3">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            ...
            <a href="{{ route('posts.create') }}" class="p-2 text-dark">Form</a>
        </nav>
    </div>
    <div class="container">
        @if (session('status'))
